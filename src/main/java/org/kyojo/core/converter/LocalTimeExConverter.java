...
public final class LocalTimeExConverter extends AbstractConverter {

	public LocalTimeExConverter() {
		super();
	}

	public LocalTimeExConverter(final Object defaultValue) {
		super(defaultValue);
	}
	...
	private LocalTime toLocalTime(final Object value) throws Throwable {
		LocalTime lt = null;
	...
	private <T> T localTimeToType(final Class<T> type, final LocalTime lt) throws Throwable {
