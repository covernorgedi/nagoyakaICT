...
public final class LocalDateExConverter extends AbstractConverter {

	public LocalDateExConverter() {
		super();
	}

	public LocalDateExConverter(final Object defaultValue) {
		super(defaultValue);
	}
	...
	private LocalDate toLocalDate(final Object value) throws Throwable {
		LocalDate ld = null;
	...
	private <T> T localDateToType(final Class<T> type, final LocalDate ld) throws Throwable {
