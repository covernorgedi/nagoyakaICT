package jp.nagoyakanet.ict.plugin.doc.pharmacist
...
class HomeCareManagementGuidanceReport extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(HomeCareManagementGuidanceReport.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		HomeCareManagementGuidanceReport homeCareManagementGuidanceReport01 = new HomeCareManagementGuidanceReport()
		homeCareManagementGuidanceReport01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-07-07 09:35:22")

		DocMinion dscdt01 = new DocMinion("doc.pharmacist.homeCareManagementGuidanceReport", "mnn", homeCareManagementGuidanceReport01,
