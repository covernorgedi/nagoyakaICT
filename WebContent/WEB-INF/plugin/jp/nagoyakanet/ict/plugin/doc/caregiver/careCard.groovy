...
class CareCard extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(CareCard.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		CareCard careCard01 = new CareCard()
		careCard01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-08-13 06:46:28")

		DocMinion dscdt01 = new DocMinion("doc.caregiver.careCard", "mnn", careCard01,
