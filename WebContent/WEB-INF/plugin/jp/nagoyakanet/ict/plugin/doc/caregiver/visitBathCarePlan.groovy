...
class VisitBathCarePlan extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitBathCarePlan.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitBathCarePlan visitBathCarePlan01 = new VisitBathCarePlan()
		visitBathCarePlan01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-02-04 15:47:27")

		DocMinion dscdt01 = new DocMinion("doc.caregiver.visitBathCarePlan", "mnn", visitBathCarePlan01,
