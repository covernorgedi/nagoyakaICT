...
class VisitNurseRecord2 extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitNurseRecord2.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitNurseRecord2 visitNurseRecord201 = new VisitNurseRecord2()
		visitNurseRecord201.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-05-05 14:48:47")

		DocMinion dscdt01 = new DocMinion("doc.nurse.visitNurseRecord2", "mnn", visitNurseRecord201,
