...
class VisitRehabRecord extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitRehabRecord.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitRehabRecord visitRehabRecord01 = new VisitRehabRecord()
		visitRehabRecord01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-07-11 21:21:49")

		DocMinion dscdt01 = new DocMinion("doc.rehab.visitRehabRecord", "mnn", visitRehabRecord01,
