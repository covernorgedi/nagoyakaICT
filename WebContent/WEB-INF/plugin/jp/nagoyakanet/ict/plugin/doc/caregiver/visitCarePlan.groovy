...
class VisitCarePlan extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitCarePlan.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitCarePlan visitCarePlan01 = new VisitCarePlan()
		visitCarePlan01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-03-25 11:47:14")

		DocMinion dscdt01 = new DocMinion("doc.caregiver.visitCarePlan", "mnn", visitCarePlan01,
