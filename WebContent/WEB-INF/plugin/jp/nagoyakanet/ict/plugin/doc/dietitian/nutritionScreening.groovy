package jp.nagoyakanet.ict.plugin.doc.dietitian
...
class NutritionScreening extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(NutritionScreening.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		NutritionScreening nutritionScreening01 = new NutritionScreening()
		nutritionScreening01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-06-07 18:45:44")

		DocMinion dscdt01 = new DocMinion("doc.dietitian.nutritionScreening", "mnn", nutritionScreening01,
