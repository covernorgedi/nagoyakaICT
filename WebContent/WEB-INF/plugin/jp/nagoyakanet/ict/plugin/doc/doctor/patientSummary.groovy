...
class PatientSummary extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(PatientSummary.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		PatientSummary patientSummary01 = new PatientSummary()
		patientSummary01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-06-26 01:15:01")

		DocMinion dscdt01 = new DocMinion("doc.doctor.patientSummary", "mnn", patientSummary01,
