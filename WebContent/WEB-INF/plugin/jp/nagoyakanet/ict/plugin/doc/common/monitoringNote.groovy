package jp.nagoyakanet.ict.plugin.doc.common
...
class MonitoringNote extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(MonitoringNote.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		MonitoringNote monitoringNote01 = new MonitoringNote()
		monitoringNote01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-12-31 00:46:07")

		DocMinion dscdt01 = new DocMinion("doc.common.monitoringNote", "mnn", monitoringNote01,
