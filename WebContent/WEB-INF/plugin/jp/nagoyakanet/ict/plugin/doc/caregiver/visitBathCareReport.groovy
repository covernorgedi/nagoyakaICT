package jp.nagoyakanet.ict.plugin.doc.caregiver
...
class VisitBathCareReport extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitBathCareReport.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitBathCareReport visitBathCareReport01 = new VisitBathCareReport()
		visitBathCareReport01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-03-30 11:20:23")

		DocMinion dscdt01 = new DocMinion("doc.caregiver.visitBathCareReport", "mnn", visitBathCareReport01,
