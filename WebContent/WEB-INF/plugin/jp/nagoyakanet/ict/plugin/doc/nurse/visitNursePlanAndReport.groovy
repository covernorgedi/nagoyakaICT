package jp.nagoyakanet.ict.plugin.doc.nurse
...
class VisitNursePlanAndReport extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitNursePlanAndReport.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitNursePlanAndReport visitNursePlanAndReport01 = new VisitNursePlanAndReport()
		visitNursePlanAndReport01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-07-23 18:44:42")

		DocMinion dscdt01 = new DocMinion("doc.nurse.visitNursePlanAndReport", "mnn", visitNursePlanAndReport01,
