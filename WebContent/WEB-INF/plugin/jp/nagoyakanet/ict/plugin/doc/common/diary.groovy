...
class Diary extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(Diary.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		diary01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-12-17 03:03:20")

		DocMinion dscdt01 = new DocMinion("doc.common.diary", "mnn", diary01,
