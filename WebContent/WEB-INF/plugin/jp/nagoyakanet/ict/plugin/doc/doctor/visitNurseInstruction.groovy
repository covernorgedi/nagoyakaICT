...
class VisitNurseInstruction extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitNurseInstruction.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitNurseInstruction visitNurseInstruction01 = new VisitNurseInstruction()
		visitNurseInstruction01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-02-27 15:08:14")

		DocMinion dscdt01 = new DocMinion("doc.doctor.visitNurseInstruction", "mnn", visitNurseInstruction01,
