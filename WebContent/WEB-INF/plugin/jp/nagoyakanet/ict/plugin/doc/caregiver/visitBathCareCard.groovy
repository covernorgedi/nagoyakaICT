...
class VisitBathCareCard extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitBathCareCard.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitBathCareCard visitBathCareCard01 = new VisitBathCareCard()
		visitBathCareCard01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-03-23 04:51:53")

		DocMinion dscdt01 = new DocMinion("doc.caregiver.visitBathCareCard", "mnn", visitBathCareCard01,
