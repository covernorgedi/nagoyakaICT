...
class NutritionCarePlan extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(NutritionCarePlan.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		NutritionCarePlan nutritionCarePlan01 = new NutritionCarePlan()
		nutritionCarePlan01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-06-28 12:40:11")

		DocMinion dscdt01 = new DocMinion("doc.dietitian.nutritionCarePlan", "mnn", nutritionCarePlan01,
