...
class VisitNurseRecord1 extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(VisitNurseRecord1.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		VisitNurseRecord1 visitNurseRecord101 = new VisitNurseRecord1()
		visitNurseRecord101.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-09-18 18:29:52")

		DocMinion dscdt01 = new DocMinion("doc.nurse.visitNurseRecord1", "mnn", visitNurseRecord101,
