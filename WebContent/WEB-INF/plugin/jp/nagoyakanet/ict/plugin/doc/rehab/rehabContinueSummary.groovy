package jp.nagoyakanet.ict.plugin.doc.rehab
...
class RehabContinueSummary extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(RehabContinueSummary.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		RehabContinueSummary rehabContinueSummary01 = new RehabContinueSummary()
		rehabContinueSummary01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-02-01 01:43:41")

		DocMinion dscdt01 = new DocMinion("doc.rehab.rehabContinueSummary", "mnn", rehabContinueSummary01,
