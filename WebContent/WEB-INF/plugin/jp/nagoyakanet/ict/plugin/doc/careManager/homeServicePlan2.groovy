...
class HomeServicePlan2 extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(HomeServicePlan2.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		HomeServicePlan2 homeServicePlan201 = new HomeServicePlan2()
		homeServicePlan201.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-07-13 13:45:19")

		DocMinion dscdt01 = new DocMinion("doc.careManager.homeServicePlan2", "mnn", homeServicePlan201,
