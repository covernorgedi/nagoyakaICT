...
class WeeklyServicePlan extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(WeeklyServicePlan.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		WeeklyServicePlan weeklyServicePlan01 = new WeeklyServicePlan()
		weeklyServicePlan01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-05-17 05:16:38")

		DocMinion dscdt01 = new DocMinion("doc.careManager.weeklyServicePlan", "mnn", weeklyServicePlan01,
