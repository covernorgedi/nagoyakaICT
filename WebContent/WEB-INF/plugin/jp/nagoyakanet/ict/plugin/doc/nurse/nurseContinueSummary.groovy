...
class NurseContinueSummary extends AbstractDocumentPage {

	private static final Log logger = LogFactory.getLog(NurseContinueSummary.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		NurseContinueSummary nurseContinueSummary01 = new NurseContinueSummary()
		nurseContinueSummary01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-11-20 05:14:19")

		DocMinion dscdt01 = new DocMinion("doc.nurse.nurseContinueSummary", "mnn", nurseContinueSummary01,
