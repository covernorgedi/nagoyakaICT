...
class Disabilities extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(Disabilities.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		Disabilities disabilities01 = new Disabilities()
		disabilities01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-09-05 17:24:14")

		DocMinion dscdt01 = new DocMinion("reg.lifeCare.disabilities", "mnn", disabilities01,
