...
class CarePublicExpense extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(CarePublicExpense.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		CarePublicExpense carePublicExpense01 = new CarePublicExpense()
		carePublicExpense01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-01-31 07:44:18")

		DocMinion dscdt01 = new DocMinion("reg.insurance.carePublicExpense", "mnn", carePublicExpense01,
