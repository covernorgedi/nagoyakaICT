...
class PhyOralMwLife extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(PhyOralMwLife.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		PhyOralMwLife phyOralMwLife01 = new PhyOralMwLife()
		phyOralMwLife01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-01-04 12:07:42")

		DocMinion dscdt01 = new DocMinion("reg.lifeCare.phyOralMwLife", "mnn", phyOralMwLife01,
