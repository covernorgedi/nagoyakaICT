...
class CareInsurance extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(CareInsurance.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		CareInsurance careInsurance01 = new CareInsurance()
		careInsurance01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-06-16 09:44:38")

		DocMinion dscdt01 = new DocMinion("reg.insurance.careInsurance", "mnn", careInsurance01,
