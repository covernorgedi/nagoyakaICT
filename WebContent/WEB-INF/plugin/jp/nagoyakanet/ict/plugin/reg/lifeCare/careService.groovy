...
class CareService extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(CareService.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		CareService careService01 = new CareService()
		careService01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-06-18 00:59:04")

		DocMinion dscdt01 = new DocMinion("reg.lifeCare.careService", "mnn", careService01,
