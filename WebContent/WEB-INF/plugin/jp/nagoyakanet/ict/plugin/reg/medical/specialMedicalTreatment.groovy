...
class SpecialMedicalTreatment extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(SpecialMedicalTreatment.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		SpecialMedicalTreatment specialMedicalTreatment01 = new SpecialMedicalTreatment()
		specialMedicalTreatment01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-02-13 03:22:00")

		DocMinion dscdt01 = new DocMinion("reg.medical.specialMedicalTreatment", "mnn", specialMedicalTreatment01,
