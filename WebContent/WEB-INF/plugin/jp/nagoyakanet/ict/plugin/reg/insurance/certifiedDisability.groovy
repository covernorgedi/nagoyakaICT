...
class CertifiedDisability extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(CertifiedDisability.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		CertifiedDisability certifiedDisability01 = new CertifiedDisability()
		certifiedDisability01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-05-22 03:45:06")

		DocMinion dscdt01 = new DocMinion("reg.insurance.certifiedDisability", "mnn", certifiedDisability01,
