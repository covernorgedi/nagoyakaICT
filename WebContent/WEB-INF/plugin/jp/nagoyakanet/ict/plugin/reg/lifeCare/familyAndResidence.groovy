package jp.nagoyakanet.ict.plugin.reg.lifeCare
...
class FamilyAndResidence extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(FamilyAndResidence.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		FamilyAndResidence familyAndResidence01 = new FamilyAndResidence()
		familyAndResidence01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-05-23 10:15:52")

		DocMinion dscdt01 = new DocMinion("reg.lifeCare.familyAndResidence", "mnn", familyAndResidence01,
