...
class AdlAndIadl extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(AdlAndIadl.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		AdlAndIadl adlAndIadl01 = new AdlAndIadl()
		adlAndIadl01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-11-25 16:10:56")

		DocMinion dscdt01 = new DocMinion("reg.lifeCare.adlAndIadl", "mnn", adlAndIadl01,
