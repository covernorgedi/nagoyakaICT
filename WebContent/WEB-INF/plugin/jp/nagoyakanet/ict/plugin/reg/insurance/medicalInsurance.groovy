...
class MedicalInsurance extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(MedicalInsurance.class)
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		MedicalInsurance medicalInsurance01 = new MedicalInsurance()
		medicalInsurance01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
				docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2016-05-14 16:11:22")

		DocMinion dscdt01 = new DocMinion("reg.insurance.medicalInsurance", "mnn", medicalInsurance01,
