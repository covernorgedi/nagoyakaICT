...
class CertifiedCareLevel extends AbstractRegistryPage {

	private static final Log logger = LogFactory.getLog(CertifiedCareLevel.class)

	CreateAction createAction
	ConsumeAction consumeAction
	CreativeWork creativeWork

	String certifiedStatus // 認定状態
	String careLevel // 要介護度
	Date certifiedFrom // 認定有効期間from
	Date certifiedTo // 認定有効期間to
	...
	static boolean insertSamples(Map<String, User> users, Map<String, Office> offices, Map<String, Team> teams,
		...
		CertifiedCareLevel certifiedCareLevel01 = new CertifiedCareLevel();
		certifiedCareLevel01.clear(docUsers.get("武田　拓夫"), docOffices.get("山中病院"),
			docTeams.get("新川　光彦さんのケアチーム"), docUsers.get("新川　光彦"))
		Date createdAt01 = sdfYMDHMS.parse("2017-08-08 12:31:52")
		certifiedCareLevel01.createAction.createdAt = createdAt01
		certifiedCareLevel01.creativeWork.createdAt = createdAt01
		certifiedCareLevel01.creativeWork.dateCreated = new DATE_CREATED(createdAt01)
		certifiedCareLevel01.creativeWork.dateModified = new DATE_MODIFIED(createdAt01)
		certifiedCareLevel01.creativeWork.datePublished = new DATE_PUBLISHED(createdAt01)
		certifiedCareLevel01.certifiedStatus = "1"
		certifiedCareLevel01.careLevel = "c4"
		certifiedCareLevel01.certifiedFrom = sdfYMDHMS.parse("2016-02-01 00:00:00")
		certifiedCareLevel01.certifiedTo = sdfYMDHMS.parse("2016-03-31 00:00:00")
		DocMinion dscdt01 = new DocMinion("reg.insurance.certifiedCareLevel", "mnn", certifiedCareLevel01,
